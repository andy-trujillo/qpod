ARG GITPOD_IMAGE=gitpod/workspace-java-17:latest
FROM ${GITPOD_IMAGE}
...
## Install Velero
RUN curl -sL -o velero-v1.9.2-linux-amd64.tar.gz https://github.com/vmware-tanzu/velero/releases/download/v1.9.2/velero-v1.9.2-linux-amd64.tar.gz && \
  tar -xzf velero-v1.9.2-linux-amd64.tar.gz  && \
  sudo mv velero-v1.9.2-linux-amd64/velero /usr/local/bin/velero
